          ...
          >
            <h1 className="font-extrabold">
              <span className="text-white text-8xl ">
                Hello, I'm{" "} 
                <span className="text-transparent bg-clip-text sm:text-8xl md:text-9xl bg-gradient-to-r  from-indigo-500 via-purple-500 to-sky-400">
                Yi Ling
                </span>
              </span>
              <br></br>
              ...
              <TypeWritter
                ...
                onInit={(typewriter) => {
                    typewriter
                    .typeString(`<span style="color:#96cfd6">Web Developer</span>`)
                    .pauseFor(1300)
                    .deleteAll()
                    .typeString(`<span style="color:#9E7BFF">SE Student</span>`)
                    .pauseFor(1300)
                    .deleteAll()
                    .start();
            ...
            <Link 
                href={"/resume.pdf"}
                className="px-6 inline-block py-3 rounded-full border-2 border-sky-300 hover:bg-sky-400"
                target="blank"
